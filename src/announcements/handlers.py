...
@form_router.get("/announcement_form", response_model=FastUI, response_model_exclude_none=True)
...
@router.post('/create_announcement', response_model=FastUI, response_model_exclude_none=True)
async def create_announcement(
    ...
    return [
        ...
        get_navbar(),
        c.Link(components=[c.Text(text='Назад')], on_click=c.events.BackEvent(), class_name='btn btn-primary w-25'),
    ]
