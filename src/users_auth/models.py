...
from core.mixins import IDPKINTMixin, UserRelationMixin, AuthUserRelationMixin
...
class AuthUser(Base, IDPKINTMixin, UserRelationMixin, SQLAlchemyBaseUserTable[int]):
    _user_options = {
...
class AccessToken(Base, AuthUserRelationMixin, SQLAlchemyBaseAccessTokenTable[int]):
    _auth_user_options = {
